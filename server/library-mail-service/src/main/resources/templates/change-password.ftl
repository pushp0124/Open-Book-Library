...
<h3 style="font-size : 21px;"> Hi, ${user.userName} </h3>


<div style = "font-size : 18px; margin-top: 5px;margin-bottom: 5px; line-height : 21px;">Password changed successfully !</div>
