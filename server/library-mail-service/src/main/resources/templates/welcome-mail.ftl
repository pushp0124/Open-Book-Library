                ...
                <table
                    ...
                    <tr>
                        <td style="height: 100px; text-align : right;">
                            ...
                            <table style="width : 100%">
                                ...
                                <tr>
                                    <td>
                                        <h3 style="text-align : left; font-size : 26px;"> Open Book Library - Where you matters </h3>
                    ...
                    <tr>
                        ...
                        <hr>
                            ...
                            <h4 style="text-align : left; font-size : 21px;"> Hi, ${welcomeUser.userName} </h4>

<div style = "font-size : 20px; margin-top: 5px;margin-bottom: 5px; line-height : 30px;">Congratulations, your account is successfully registered, please login and borrow exciting books, for free!</div>
