package com.obl.gateway_security.security;
...
import com.obl.gateway_security.services.LibraryUserDetailsService;
...
public class JwtTokenProvider {
    ...
    private String secretKey="0959649384";
...
//    }
    ...
    public UserDetails getUserDetails(String token) {
        ...
        UserDetails userDetails = new LibraryUserDetails(userName,roleList.toArray(new String[roleList.size()]));
        return userDetails;
    }
